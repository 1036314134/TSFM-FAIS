"""Score frozen R32 predictions using observed-prefix standardized downstream errors."""
...
from cooutage_calibration_core import BASE, PARENT, ROOT, load_npz, read_json
...
def main():
    ...
    if (output / "manifest.json").exists():
        raise ValueError("preserve complete R32 scores")
